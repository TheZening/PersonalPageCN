---
title: "绝热定理与 Berry 相位"
date: 2024-10-11
weight: 1
legacySeries: "QM1"
aliases:
  - "/notes/Quantum_Mechanics/Advanced_Topics/Adiabatic_and_Berry_Phase/"
  - "/qm1/QM1-AdiabaticTheoremAndBerryPhase/"
---
...
![Quick Change](quick-change.gif)
可以说是乱七八糟, 毫无规律.
不过这也正常, 就想你突然被人推了一把, 你会乱跑.

但是如果势能$V(x)$是缓慢变化的, 我们的波函数会怎么反应.
![Slow Change](slow-change.gif)
...
> 所以$\ket{n;t}$是一个瞬时的概念, 如果我们以他为初态, 我们在$t+t_1$时刻得到的态是$U(t+t_1, t)\ket{n;t}$, 这一般不等于$\ket{n;t+t_1}$.
> 而$\ket{n;t+t_1}$是另一个时刻的瞬时本征态, 它与$\ket{n;t}$没有直接的关系.
> 而绝热定理就告诉了我们什么情况下可能有关系.
...
![AB 效应示意图](aharonov-bohm-effect.png "Aharonov-Bohm 效应图示")
